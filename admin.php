...
if (!defined('ADMIN_EMAIL')) {
    define('ADMIN_EMAIL', 'admin@travelbudy.in'); // Ensure this matches login_handler.php
}
...
<head>
    ...
    <style>
        ...
        .welcome-message { font-size: 1.1em; color: #4a5568; /* Tailwind gray-700 */}
        .section-title {
        ...
        .form-input:focus, .form-textarea:focus {
             border-color: #FF5E00;
             outline: none;
             box-shadow: 0 0 0 3px rgba(255, 94, 0, 0.2); /* Ring effect */
        }
        .form-textarea {
            min-height: 100px;
        }
        ...
        .alert-success { background-color: #c6f6d5; color: #2f855a; border-color: #9ae6b4; } /* Tailwind green */
        .alert-error { background-color: #fed7d7; color: #c53030; border-color: #feb2b2; } /* Tailwind red */
    </style>
</head>
